...
{ 
    ...
    map = {23,24,59,52,21,22,59,21,23,17,23,0},    --地图组，此id对应MapGroupConfig中配置文件，0表示无地图组
...
SelectLevel[3]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
        map = {22,24,87,25,12,13,10,17,24,8,5,4,8,5,2,5,60,8,60,0},
        gap = 10,    --每组之间的间隔差距，单位:像素
        speed = 80,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[4]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
        map = {23,25,24,6,1,9,13,64,8,9,0},
        gap = 10,    --每组之间的间隔差距，单位:像素
        speed = 60,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[5]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
        map = {12,22,5,98,22,4,61,64,60,65,21,4,12,97,19,2,21,5,21,26,11,11,0},
        gap = 10,    --每组之间的间隔差距，单位:像素
        speed = 75,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[8]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
        map = {37,12,4,19,16,18,6,14,12,14,12,21,0},
        gap = 60,    --每组之间的间隔差距，单位:像素
        speed = 75,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[9]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
        map = {64,18,17,13,6,14,12,29,23,29,23,21,56,57,17,26,16,16,0},
        gap = 60,    --每组之间的间隔差距，单位:像素
        speed = 75,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[11]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
        map = {81,80,82,98,23,25,8,17,1,10,1,17,24,1,17,25,22,0},
        gap = 50,    --每组之间的间隔差距，单位:像素
        speed = 75,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[13]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
        map = {21,25,4,18,24,23,25,18,17,6,10,6,18,21,17,18,83,10,80,17,98,64,54,4,15,0},
...
SelectLevel[19]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
    map = {47,19,27,13,6,18,30,17,17,28,19,36,24,28,30,30,1,1,17,18,16,30,11,0},    
    gap = 10,    --每组之间的间隔差距，单位:像素
    speed = 70,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[23]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
    map = {81,82,14,12,4,14,20,83,21,4,12,17,19,2,21,83,21,32,33,34,35,91,101,31,82,33,6,31,32,32,29,33,34,35,28,20,33,90,17,0}, 
    gap = 10,    --每组之间的间隔差距，单位:像素
    speed = 70,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[25]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
    map = {23,17,105,0,34,33,32,33,34,36,57,21,33,100,87,33,6,23,24,98,18,28,32,29,77,33,36,39,0},    
    gap = 10,    --每组之间的间隔差距，单位:像素
    speed = 70,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[26]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
    map = {16,2,78,2,2,3,16,16,34,38,18,5,5,28,19,27,13,17,17,28,19,34,38,38,17,10,2,21,4,21,14,33,0}, 
    gap = 10,    --每组之间的间隔差距，单位:像素
    speed = 70,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[27]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
    map = {11,40,18,41,17,39,30,13,6,38,27,26,14,12,29,23,38,39,29,23,21,14,40,26,41,16,0}, 
    gap = 10,    --每组之间的间隔差距，单位:像素
    speed = 70,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[28]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
    map = {33,23,24,55,82,83,65,23,38,21,43,42,26,37,16,33,40,21,38,17,39,30,13,6,38,27,26,14,12,0},
    gap = 10,    --每组之间的间隔差距，单位:像素
    speed = 75,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[33]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
    map = {64,2,57,30,30,66,27,19,22,38,82,21,31,17,18,82,31,10,2,21,4,21,40,66,34,35,66,31,40,17,16,31,32,29,0}, 
    gap = 10,    --每组之间的间隔差距，单位:像素
    speed = 75,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
...
SelectLevel[40]= 
    { 
        ...
        powerAward=false, --体力奖励
        startGoods={1,2,3,4,5}, --开局道具
    map = {98,40,83,71,77,81,100,80,27,79,95,16,20,93,31,17,18,88,16,31,10,89,2,21,4,21,40,16,90,34,35,16,31,104,40,17,16,31,32,29,105,0},  
    gap = 10,    --每组之间的间隔差距，单位:像素
    speed = 75,  --每一关卡速度
        getStar = function(score)     --星级分数配置
            if score >= 300 then
