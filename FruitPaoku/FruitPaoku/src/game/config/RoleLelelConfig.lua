...
RoleLvs[1][1]=
    {
        ...
        --金币不足时
        needDiamondNum = 1,  -- 金币和钻石换算
    
    --        --升级需求详解
    --[钻石类型]
    --        {
    --        needsType = 1,  -- 1钻石 2金币 3道具
    --            diamondNum = 138,   --所需数量
    --        },
    ...
    --[宝石类型]
    --        {
    --            needsType = 3, -- 1钻石 2金币 3道具
    --            goodsId=18,    --道具编号(对应的石头为18,19,20)
    --            goodsNum = 1   --道具数量
    --        },
    --        {
    --            needsType= 3, -- 1钻石 2金币 3道具
    --            goodsId  = 19,    --道具编号(对应的石头为18,19,20)
    --            goodsNum = 1   --道具数量
    --        },
    --        {
    --            needsType= 3, -- 1钻石 2金币 3道具
    --            goodsId  = 20,    --道具编号(对应的石头为18,19,20)
    --            goodsNum = 1   --道具数量
    --        },
    }
RoleLvs[1][2]=
