...
local fightRes = {
    ...
    {type = PreLoadType.Texture,plist="role/RoleJump11.plist",png="role/RoleJump11.png"},
    {type = PreLoadType.Texture,plist="role/RoleJump12.plist",png="role/RoleJump12.png"},
    {type = PreLoadType.Texture,plist="role/RoleJump13.plist",png="role/RoleJump13.png"},
    {type = PreLoadType.Animate,plist = "role/RoleJump.plist"},
    {type = PreLoadType.Animate,plist = "role/RoleJump_p.plist"},
...
local playerRes = {
    ...
    {type = PreLoadType.Texture,plist="role/Role11.plist",png="role/Role11.png"},
    {type = PreLoadType.Texture,plist="role/Role12.plist",png="role/Role12.png"},
    {type = PreLoadType.Texture,plist="role/Role13.plist",png="role/Role13.png"},
    {type = PreLoadType.Animate,plist = "role/RoleAni.plist"},
    {type = PreLoadType.Animate,plist = "role/RoleAni_p.plist"},
    {type = PreLoadType.Texture,plist="role/RoleJump7.plist",png="role/RoleJump7.png"},
    {type = PreLoadType.Animate,plist = "role/RoleJump_7.plist"},
