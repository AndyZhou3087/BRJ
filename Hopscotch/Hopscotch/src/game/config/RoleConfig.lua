...
RoleConfig[2]=
    {
        id = 2,
        type = Shop_Type.role,
        armatureName = "RoleAni_11",   --动画工程名
        jumpName = "RoleJump_11",   --跳跃动画名
        roleImg = "role/role_11.png",   --角色图片
        roleName = "shop/rolename_11.png",
        priceRes = "shop/price_6.png",
        roleDes = "李大头",  --角色描述
        giftName = "shop/gift_role_11.png",
        rmb = 6,   --人民币购买价格
        diamond = 200,  --钻石购买价格
        lifeNum = 1,
        payId = Payment.Role_6,
...
RoleConfig[3]=
    {
        id = 3,
        type = Shop_Type.role,
        armatureName = "RoleAni_12",   --动画工程名
        jumpName = "RoleJump_12",   --跳跃动画名
        roleImg = "role/role_12.png",   --角色图片
        roleName = "shop/rolename_12.png",
        priceRes = "shop/price_6.png",
        roleDes = "阿华",  --角色描述
        giftName = "shop/gift_role_12.png",
        rmb = 6,   --人民币购买价格
        diamond = 200,  --钻石购买价格
        lifeNum = 1,
        payId = Payment.Role_6,
...
RoleConfig[4]=
    {
        id = 4,
        type = Shop_Type.role,
        armatureName = "RoleAni_13",   --动画工程名
        jumpName = "RoleJump_13",   --跳跃动画名
        roleImg = "role/role_13.png",   --角色图片
        roleName = "shop/rolename_13.png",
        priceRes = "shop/price_6.png",
        roleDes = "小强",  --角色描述
        giftName = "shop/gift_role_13.png",
        rmb = 6,   --人民币购买价格
        diamond = 200,  --钻石购买价格
        lifeNum = 1,
        payId = Payment.Role_6,
